...
public class Run {
    ...
    private static final String NODES_INDEPENDENT = "2p_Independent_Nodes_10_WeightType_Random.dot";

    private static final String FILENAME = NODES_FORK_JOIN; // SET INPUT HERE
